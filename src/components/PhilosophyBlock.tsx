...
const steps: Step[] = [
  {
    ...
    icon: (
      <svg className="w-5 h-5 sm:w-6 sm:h-6 md:w-7 md:h-7" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" style={{ color: "var(--intent-decisive)" }}>
  ...
  },
  {
    ...
    icon: (
      <svg className="w-5 h-5 sm:w-6 sm:h-6 md:w-7 md:h-7" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" style={{ color: "var(--intent-natural)" }}>
  ...
  },
  {
    ...
    icon: (
      <svg className="w-5 h-5 sm:w-6 sm:h-6 md:w-7 md:h-7" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" style={{ color: "var(--intent-calm)" }}>
        <path d="M20 20H4V4" />
...
function StepCard({ step }: { step: Step }) {
  ...
  return (
    ...
    >
      {/* Icon */}
      <motion.div 
        className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 rounded-full flex items-center justify-center shadow-sm border mb-3 sm:mb-4"
        style={{ 
      ...
      >
        <span className="text-xs sm:text-sm font-semibold text-[color:rgba(11,11,12,0.5)] mr-2">{step.number}.</span>
        <h3 className="text-lg sm:text-xl font-bold text-[color:var(--ink)] leading-tight inline">
          {step.label}
        </h3>
      </motion.div>
      ...
      {/* Description */}
      <motion.p 
        className="text-sm sm:text-base text-[color:rgba(11,11,12,0.7)] leading-relaxed font-normal max-w-[280px] px-2"
        style={{
          opacity: descOpacity
        }}
      >
...
export default function PhilosophyBlock() {
  ...
  return (
    <section ref={ref} className="relative mx-auto max-w-5xl px-4 sm:px-5 md:px-6 py-12 sm:py-16 md:py-20 lg:py-28">
      {/* Decorative divider */}
      ...
      <div className="relative z-10">
        ...
        <div className="text-center mb-6">
          <motion.h2
            ...
            className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold text-[color:var(--ink)] leading-tight mb-2 sm:mb-3 px-2 sm:px-4"
          ...
          <motion.p
            ...
            className="text-sm sm:text-base md:text-lg lg:text-xl text-[color:rgba(11,11,12,0.7)] max-w-2xl mx-auto leading-relaxed font-medium px-2 sm:px-4"
          >
        ...
        {/* Steps */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 md:gap-10 lg:gap-12 mt-10 sm:mt-12 md:mt-16 lg:mt-20">
          {steps.map((step) => (
        ...
        <motion.p
          ...
          className="text-center mt-8 sm:mt-10 md:mt-12 lg:mt-16 text-sm sm:text-base md:text-lg text-[color:rgba(11,11,12,0.6)] font-medium italic px-4"
        >
